...
Config.NPCJobEarnings             = {min = 6000, max = 10000}
...
Config.AuthorizedVehicles = {
	{model = 'e63amg', label = 'E63AMG'},
	{model = 'trans_mbv250', label = 'v250'}
}
